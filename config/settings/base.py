...
# CHANGED IT FROM DEFALUT COOKIECUTTER STUFF TO HARD-CODED DICT
DATABASES = {
    'default': {
...
LOCAL_APPS = [
    "everycheese.users.apps.UsersConfig", #custom users aoo
...
ADMINS = [("Kizyma Yaroslav", "kizimayarik01@gmail.com")]
